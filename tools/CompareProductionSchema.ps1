...
$toolProject = Join-Path $root 'tools\CompareProductionSchema\CompareProductionSchema.csproj'
...
if ([string]::IsNullOrWhiteSpace($secret)) {
    throw "Connessione locale non trovata nei user-secrets."
}
...
if ([string]::IsNullOrWhiteSpace($remote)) {
    throw "Connessione di produzione non trovata."
}
