...
public sealed record SupplierLookups(
...
public sealed record SupplierDeleteResult(bool Deleted, string Message);

public sealed record SupplierPrintRequest(IReadOnlyList<int> Codes);
